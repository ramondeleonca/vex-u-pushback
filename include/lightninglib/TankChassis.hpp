...
class TankChassis {
 private:
  ...
  pros::ADIEncoder Encoder_Forward_tracker;
  pros::ADIEncoder Encoder_SideWays_tracker;
 ...
 */
  ...
  */
   ...
   */
  pros::motor_encoder_units_e_t get_encoders_units() const ;

  /**
   * @brief Gets the current brake mode
   * @return Motors brake
   */
  pros::motor_brake_mode_e_t get_actual_brake() const ;
